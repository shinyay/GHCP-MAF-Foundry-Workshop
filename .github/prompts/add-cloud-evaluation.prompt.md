...
- 詳細パターン: [`kb-1.8.0/patterns/observability-otel.md`](../../kb-1.8.0/patterns/observability-otel.md) の Evaluation セクション。
...
- [`kb-1.8.0/patterns/observability-otel.md`](../../kb-1.8.0/patterns/observability-otel.md) — Cloud Evaluation 詳細
